...
public class TryAgain extends JFrame {
    TryAgain() {
        ...
        tryAgainButton.setText("BETTER LUCK NEXT TIME");
        tryAgainButton.setFont(new Font(("Times New Roman"), Font.CENTER_BASELINE, 20));
        ...
        exitButton.setFont(new Font(("Times New Roman"), Font.CENTER_BASELINE, 20));
